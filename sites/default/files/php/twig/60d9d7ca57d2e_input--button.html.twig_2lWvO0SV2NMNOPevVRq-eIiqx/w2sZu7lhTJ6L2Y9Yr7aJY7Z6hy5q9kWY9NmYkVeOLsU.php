...
class __TwigTemplate_6b5dc3de5674c5e618db26857f48a01ce3891bc775c6627905597526ed72f6e6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/var/www/html/projetos/free/drupal9-2-theme/themes/bootstrap/templates/input/input--button.html.twig");
    }
